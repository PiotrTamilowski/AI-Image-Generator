...
const firstRowImages = [new img("images/1.jpg"), new img("images/9.jpg"), new img("images/16.jpg"), new img("images/22.jpg"), new img("images/25.jpg"), new img("images/96.jpg"), new img("images/113.jpg"), new img("images/122.jpg"), new img("images/19.jpg"), new img("images/87.jpg")];
const secondRowImages = [new img("images/37.jpg"), new img("images/44.jpg"), new img("images/3.jpg"), new img("images/61.jpg"), new img("images/59.jpg"), new img("images/112.jpg"), new img("images/108.jpg"), new img("images/118.jpg"), new img("images/70.jpg"), new img("images/82.jpg")];
const thirdRowImages = [new img("images/68.jpg"), new img("images/47.jpg"), new img("images/51.jpg"), new img("images/64.jpg"), new img("images/121.jpg"), new img("images/110.jpg"), new img("images/105.jpg"), new img("images/13.jpg"), new img("images/100.jpg"), new img("images/24.jpg")];
...
// this function deletes images that have moved out off the screen
